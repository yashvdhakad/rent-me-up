...
const Properties = () => {
  return (
    <section className="w-full mt-12 mb-32 p-6 rounded-xl bg-white flex flex-col gap-6 shadow">
      <h2 className="text-2xl font-bold">Top Rental Properties In Jaipur</h2>
      <div className="flex gap-6">
        {/* <Marquee className="rounded-xl" autofill speed={40} pauseOnHover> */}
        <div className="w-1/3 p-2 border border-black/10 rounded-xl flex flex-col gap-2">
          <div className="h-96 bg-jp bg-cover bg-center rounded-xl shadow flex flex-col justify-end">
            <div className="p-4 bg-white/20 backdrop-blur-xl rounded-xl border-t border-white/20 flex flex-col gap-2">
              <svg
